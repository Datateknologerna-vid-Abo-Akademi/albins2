"""
Django settings for albins2 project.
...
SERVICE_ACCOUNT_USERNAME = os.getenv("SERVICE_ACCOUNT_USERNAME", "albins_service")
...
WSGI_APPLICATION = 'albins2.wsgi.application'
